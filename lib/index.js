    ...
    initialize() {
      ...
      const getRelatedModels = (model) => {
        ...
        for (const key in attributes) {
          ...
          // TODO: probaply reintroduce bellow when following todos is fixed
        ...
        // TODO: look for direct relations in other models too
        // ...
        ...
        for (const compKey in components) {
          ...
          for (const key in attributes) {
            ...
            for (const key in attr) {
              ...
              // TODO: is this working? should also check 'collection'?
